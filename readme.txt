...
- Replace color picker with html5 color input types

= 1.3 =
- Updated with latest wordpress version.
- Design fixes.
- Fix color picker setttings
...
The new version of the plugin is having settings for:
1. Text to appear on the slider and its colors.
2. Text content background box width and its color with opacity.
3. Read More button text, background and border color setting.
4. Read More button text, background and border color settings with hover effect.
5. Setting to enable Post Title, Post Author, Post Date and Post content on the slider.
6. Setting to enable Read More button on the slider.
